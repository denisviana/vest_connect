package thedantas.vestconnect.presentation.paperonboarding;
...
import thedantas.vestconnect.presentation.paperonboarding.listeners.AnimatorEndListener;
import thedantas.vestconnect.presentation.paperonboarding.listeners.OnSwipeListener;
import thedantas.vestconnect.presentation.paperonboarding.listeners.PaperOnboardingOnChangeListener;
import thedantas.vestconnect.presentation.paperonboarding.listeners.PaperOnboardingOnLeftOutListener;
import thedantas.vestconnect.presentation.paperonboarding.listeners.PaperOnboardingOnRightOutListener;
import thedantas.vestconnect.presentation.paperonboarding.utils.PaperOnboardingEngineDefaults;
...
public class PaperOnboardingEngine implements PaperOnboardingEngineDefaults {
    ...
    protected AnimatorSet createPagerIconAnimation(int oldIndex, int newIndex) {
        ...
        oldActiveShape.setImageResource(oldIndex - newIndex > 0 ? R.drawable.onboarding_pager_circle_icon : R.drawable.onboarding_pager_circle_icon);
